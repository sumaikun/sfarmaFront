              ...
              <TableBody>
                {users.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(user => (
                  ...
                  >
                    ...
                    <TableCell>
                      {
                        props.appState.laboratories.filter( lab =>  Number(lab.prestashopId) === user.laboratory )[0] ?
                        props.appState.laboratories.filter( lab =>  Number(lab.prestashopId) === user.laboratory )[0].name : false  
                      }
                    </TableCell>
